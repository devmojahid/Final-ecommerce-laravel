                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{ $cart->product->slug }}"><img alt="Nest"
                                                ...
                                                <div class="shopping-cart-delete">
                                                    <a href="{{ route("cart.item.delete",$cart->id) }}"><i class="fi-rs-cross-small"></i></a>
                                                </div>
                                            </li>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{ route("cart-page") }}">
                                    <img alt="Nest"
                                        src="{{ asset('frontend') }}/assets/imgs/theme/icons/icon-cart.svg" />
                                    <span class="pro-count white">{{ $carts_count }}</span>
                                </a>
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        @foreach ($carts as $cart)
                                        <li>
                                            ...
                                            <div class="shopping-cart-title">
                                                <h4><a href="{{ $cart->product->slug }}">{{ $cart->product->name }}</a></h4>
                                                <h3><span>1 × </span>{{ $cart->product->price }}</h3>
                                            </div>
                                            <div class="shopping-cart-delete">
                                                <a href="{{ route("cart.item.delete",$cart->id) }}"><i class="fi-rs-cross-small"></i></a>
                                            </div>
